...
class CNN4LayersV2_p32(nn.Module):
    def __init__(self):
        # Call the initializer for the parent class
        super(CNN4LayersV2_p32, self).__init__()
...
# print("this is CNN4layersV2 model")

# model = CNN4LayersV2_p32()
# output = model(sample)
