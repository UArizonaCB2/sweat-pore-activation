...
class algorithm:
    ...
    def stratified_KFold_loader(dataset, n_splits=10, batch_size = batchSize):
        """
        This function is going to return DataLoader with 
        stratified_Kfold to get the distributed data
        """
        print(dataset[0], f'Length of dataset: {len(dataset)}')
    ...
    train_loader, test_loader = stratified_KFold_loader(dataset, n_splits=10, batch_size = batchSize)
