...
inputDirRaw='Preprocessing/input_images/testingModel/6bmp/raw'
inputDirAnnotated='Preprocessing/input_images/testingModel/6bmp/annotated'
# Output Directory
...
coordinatesDir='Preprocessing/testingModel_output_patches/6bmp/centroid_coordinates'
centroidsDir='Preprocessing/testeingModel_output_patches/6bmp/contour_images'
patchesDir='Preprocessing/testingModel_output_patches/6bmp/patch_size'
# Custom patch size 
patch_size=32
